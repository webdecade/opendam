...
if (isActive($selected, "list")) {
	...
	$albumCount = GroupePeer::countAlbumsHaveAccessForUser(citisearchActions::getListParams());
}
...
if (isActive($selected, "shared")) {
	...
	$albumSharedCount = GroupePeer::countAlbumsHaveAccessForUser(citisearchActions::getListParams());
}
