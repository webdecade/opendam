...
<?php if(in_array("email", $role)) : ?>
	...
	<?php endif; ?>
<?php endif; ?>
<?php if($file->getUserId() == '1') : ?>
	<li>
		<a href="http://citidam.mastermindmarketing.com/import/index.php?id=<?php echo $file->getId();?>" rel='facebox' onclick="setTimeout('history.go(0);',500);"><i class="icon-refresh"></i><?php echo __("Reload Tags"); ?></a>
	</li>
<?php endif; ?>
