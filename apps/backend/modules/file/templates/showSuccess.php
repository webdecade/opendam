<div class="container margin-file">
	...
	<div class="row">
		<div class="span9">
			...
			<?php include_partial("file/tags_new", array("sf_user" => $sf_user, "file" => $file, "role" => $role)); ?>
		</div>
...
<script>
	...
	jQuery(document).ready(function(){
		...
		jQuery("#nav-bottom-file-tags a:not(.inactive)").bind("click", function() {
			var div = jQuery(this).attr("rel");

			jQuery("#nav-bottom-file-tags a").removeClass("active");
			jQuery(this).addClass("active");

			jQuery("#content-bottom-file-tags .content-bottom").each(function(index) {
				if(jQuery(this).is(":visible"))
				{
					if(jQuery(this).attr("data-position") > jQuery("#" + div).attr("data-position"))
					{
