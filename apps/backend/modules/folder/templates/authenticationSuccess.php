...
<div class="container">
	<div class="row">
		<div class="span12 title-folder">
			<h2><?php echo __("Please log-in to access the folder")?></h2>
		</div>
	</div>
	<div class="row">
		<div class="span12">
			<form class="form-horizontal" name="login-folder" id="login-folder" action="" method="post">
