...
<?php include_partial("folder/subMenubarInformations", array("selected"=>"recursive", "folder"=>$folder));?>

<div id="searchResults-popup">
	<div class="inner">
		<form name="form_default" id="form_default" method="post" action="<?php echo url_for("folder/recursive"); ?>">
			...
			<label for="recurs" style="width: auto;"><?php echo __("Set as default values"); ?></label>
		</form>
