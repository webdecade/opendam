	...
	<div class="container files-container <?php echo !$showFoldersGroups ? "margin" : ""; ?>">
		<div class="files">
			<div class="container">
				<div class="row">
					<?php if(!$showFoldersGroups) : ?>
						<?php include_component("searchdate", "sidebar", Array("formatedKeywords" => $formatedKeywords, "infoGroups" => $countGroups, "infoFolders" => $countFolders, "infoFiles" => $extended, "types" => $types, "orientations" => $orientations, "sizes" => $sizes, "dates" => $dates, "filesLicences" => $filesLicences, "filesUses" => $filesUses, "filesDistributions" => $filesDistributions)) ; ?>
					<?php else: ?>
						<div class="span3"></div>
					<?php endif; ?>
