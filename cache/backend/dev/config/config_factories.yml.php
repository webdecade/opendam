...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/var/www/opendam/log/backend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/www/opendam/cache/backend/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/www/opendam/apps/backend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('wikipixel_op'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/opendam/cache/backend/dev/template',
  'lifetime' => 86400,
  'prefix' => '/var/www/opendam/apps/backend/template',
)));
